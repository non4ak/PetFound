...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260608175436_EnsureUniqueMatchNotifications")]
    partial class EnsureUniqueMatchNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Announcement", b =>
                {
                    ...
                    b.PrimitiveCollection<double[]>("Vector")
                        .HasColumnType("double precision[]");

                    b.Property<DateTimeOffset?>("VectorizedOn")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Models.Notification", b =>
                {
                    ...
                    b.HasIndex("UserId", "MatchResultId", "Type")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Models.Announcement", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Auth.ApplicationUser", "ReporterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Geotag", b =>
                {
                    b.HasOne("Domain.Models.Auth.ApplicationUser", "CreatedByUser")
                        .WithMany()
